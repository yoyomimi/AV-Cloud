...
from libs.datasets.scene.colmap_loader import (qvec2rotmat,
...
def readColmapSceneInfo(path, images, eval, align_grids=None, N_points=256, llffhold=8):
    try:
    ...
    try:
        points, colors, normals = fetchPly(ply_path, align_grids, N_points)
