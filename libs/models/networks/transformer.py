...
class Transformer(nn.Module):
    ...
    def forward(self, src, query_embed, pos_embed):
        ...
        # memory shape: (l, bs, d_model)
        memory, attn_weights = self.encoder(src, src_key_padding_mask=None, pos=pos_embed)
        ...
        # insatance decoder
        hs, attn_weights = self.decoder(query_embed, memory, memory_key_padding_mask=None,
                          pos=pos_embed)

        return  hs, memory, attn_weights
